        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">Detailed revenue breakdown and trends</p>
            </div>
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Company Performance</h3>
              <p className="text-gray-600 text-sm">Individual company metrics and KPIs</p>
            </div>
            ...
            >
              ...
              <p className="text-gray-600 text-sm">Industry trends and market analysis</p>
            </div>
            ...
            >
              ...
              <p className="text-gray-600 text-sm">Comprehensive financial metrics</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border">
            ...
            <div className="flex flex-wrap gap-4">
              <Dropdown
                trigger={
                  <div className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors cursor-pointer">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-lg font-semibold text-blue-600">{selectedReport}</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
              <h4 className="font-medium text-gray-900 mb-2">Generated</h4>
              <p className="text-lg font-semibold text-gray-600">Just now</p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="h-64 bg-white rounded border flex items-center justify-center text-gray-500">
              <div className="text-center">
                ...
                <p>Report visualization would be displayed here</p>
                <p className="text-sm mt-2">Charts, graphs, and detailed analytics</p>
              </div>
            </div>
          </div>
